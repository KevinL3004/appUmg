...
List<ProximasBajasModel> proximasBajasModelFromMap(String str) =>
    List<ProximasBajasModel>.from(
      json.decode(str).map((x) => ProximasBajasModel.fromMap(x)),
    );

class ProximasBajasModel {
  int id;
  String assetCode;
  String name;
  String description;
  ...
  factory ProximasBajasModel.fromMap(Map<String, dynamic> json) =>
      ProximasBajasModel(
        id: json["id"],
